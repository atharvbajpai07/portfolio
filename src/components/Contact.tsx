...
export default function Contact() {
    return (
        <section id="contact" className="w-full relative py-32 z-10 min-h-screen flex flex-col items-center justify-center">
            ...
            >
                ...
                <h2 className="text-5xl md:text-7xl font-display font-extrabold mb-6 tracking-tight">
                    Let's <span className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-[#8b5cf6] to-[#06b6d4]">Connect</span>
                </h2>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                    <a
                        ...
                        className="group relative inline-flex items-center justify-center px-8 py-4 font-bold text-[#050505] bg-white rounded-full overflow-hidden transition-all hover:scale-105 active:scale-95 w-full sm:w-auto"
                    >
